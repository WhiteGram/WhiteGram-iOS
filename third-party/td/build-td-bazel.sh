...
if [ "$ARCH" = "arm64" ]; then
  ...
  export CXXFLAGS="-arch arm64 --target=arm64-apple-ios13.0 -miphoneos-version-min=13.0"
  ...
  export CXXFLAGS="-arch arm64 --target=arm64-apple-ios13.0-simulator -miphonesimulator-version-min=13.0"
else
